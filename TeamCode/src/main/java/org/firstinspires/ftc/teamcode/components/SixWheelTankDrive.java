 ...
 */
@Config
public class SixWheelTankDrive extends TankDrive implements Component {
    ...
    public SixWheelTankDrive(HardwareMap map) {
        ...
        DcMotorEx leftFront = map.get(DcMotorEx.class, "fl");
        DcMotorEx leftMiddle = map.get(DcMotorEx.class, "ml");
        DcMotorEx leftRear = map.get(DcMotorEx.class, "bl");
        DcMotorEx rightRear = map.get(DcMotorEx.class, "br");
        DcMotorEx rightMiddle = map.get(DcMotorEx.class, "mr");
        DcMotorEx rightFront = map.get(DcMotorEx.class, "fr");
...
//        }
    ...
    public void setMotorPowers(double leftFrontV, double leftMiddleV, double leftRearV,
                               double rightFrontV, double rightMiddleV, double rightRearV) {
        leftMotors.get(0).setPower(leftFrontV);
        leftMotors.get(1).setPower(leftMiddleV);
        leftMotors.get(2).setPower(leftRearV);
        rightMotors.get(0).setPower(rightFrontV);
        rightMotors.get(1).setPower(rightMiddleV);
        rightMotors.get(2).setPower(rightRearV);
    }
